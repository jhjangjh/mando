#ifndef __PEDESTRIAN_LIDAR_HPP__
#define __PEDESTRIAN_LIDAR_HPP__
#pragma once
...
// Config header
#include <pedestrian_lidar_config.hpp>
...
public:
    PedestrianLidar(ros::NodeHandle &nh_);
    ~PedestrianLidar();
...
private:
    ...
    PedestrianLidarParameters pedestrian_lidar_params_;
...
#endif // __PEDESTRIAN_LIDAR_HPP__